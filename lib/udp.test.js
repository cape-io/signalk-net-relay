...
describe('sendData', () => {
  ...
  test('debug', () => {
    ...
    expect(app.debug.mock.calls.length).toBe(1)
    expect(app.debug.mock.calls[0][0]).toBe('Sent data to localhost:3033')
  })
  test('expect')
})
